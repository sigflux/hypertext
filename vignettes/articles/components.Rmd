...
say we have this `Badge()` component:
...
Badge <- function(
  label,
  variant = c("primary", "success", "danger")
) {
...
Alert <- function(
  ...
  label <- switch(
    EXPR = type,
    info = Badge(label = "info", variant = "success"),
    warning = Badge(label = "warning", variant = "primary"),
